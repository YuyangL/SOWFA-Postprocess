...
if show_baryexample:
    ...
    baryMapExample.axes.imshow(baryMap3D, origin='upper', aspect='equal', extent=(xTriLim[0], xTriLim[1],
                                                                                           yTriLim[0], yTriLim[1]))
    baryMapExample.axes.annotate(r'$\textbf{x}_{2c}$', (xTriLim[0], yTriLim[0]), (xTriLim[0] - 0.175, yTriLim[0]))
